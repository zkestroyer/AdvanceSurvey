...
async function main() {
  ...
  const schema = [
    ...
    { type: 'dropdown', label: 'Warranty', options: ["12-15 Yrs Product & 25-30 Yrs Performance Warranty"] },
    ...
    { type: 'dropdown', label: 'Brand', options: ["Huawei", "Solis", "Growatt", "Deye", "Itel Energy", "Longi", "Trina", "Canadian", "Jinko", "JA Solar", "Other"] },
    { type: 'dropdown', label: 'Model', options: ["5KW-Hybrid", "10KW-Hybrid", "15KW-Hybrid", "20KW-Hybrid", "30KW-Hybrid", "50KW-Hybrid", "Other"] },
    { type: 'dropdown', label: 'Warranty', options: ["12-15 Yrs Product & 25-30 Yrs Performance Warranty"] },
